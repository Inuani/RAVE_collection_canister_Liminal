...
import { idlFactory } from './liminal.did.js';
export { idlFactory } from './liminal.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LIMINAL;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./liminal.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the liminal canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./liminal.did.js")._SERVICE>}
 */
export const liminal = createActor(canisterId);
